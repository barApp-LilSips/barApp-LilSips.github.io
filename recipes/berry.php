...
<html lang="en">
  ...
  <a href="../home.html">
    ...
    <h3 id="par">Strawberry Gin Fizz Cocktail</h3>
    ...
    <div class="imgCont">
      <img id="drinkPicRec" src="../pics/strawberryRec.jpg" />
      ...
      if (isset($_POST["mangojito"])) {
        ...
        <select id='drink' name='drink'>
          ...
          <option value='Berry Gin Fizz' selected>Berry Gin Fizz</option>
...
?>
    ...
    <h3 class="desOrngRec">Stawberry Gin Fizz Recipe - 1 Serving</h3>
    <ul class="recipe">
      <li>1/4 Lime</li>
      <li>3 Stawberries</li>
      <li>1tbsp Sugar</li>
    ...
    <p class="description">
      AThis fresh and fruity strawberry gin drink is a cocktail that is perfect
