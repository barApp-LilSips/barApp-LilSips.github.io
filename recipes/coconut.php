...
<html lang="en">
  ...
  <a href="../home.html">
    ...
    <h3 id="par">Cocorita Cocktail</h3>
    ...
    <div class="imgCont">
      <img id="drinkPicRec" src="../pics/coconutRec.jpg" />
      ...
      if (isset($_POST["mangojito"])) {
        ...
        <select id='drink' name='drink'>
          ...
          <option value='Cocorita' selected>Cocorita</option>
...
?>
    ...
    <h3 class="desOrngRec">Cocorita Recipe - 1 Serving</h3>
    <ul class="recipe">
      <li>1.5oz Tequila</li>
    ...
    <p class="description">
      This creamy tropical twist on a classic margarita perfectly blends the
      tartness of lime and tequila with the sweetness of coconut!
    </p>
  </body>
</html>
