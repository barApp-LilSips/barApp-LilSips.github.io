...
<html lang="en">
  ...
  <a href="../home.html">
    ...
    <h3 id="par">Grapefruit Spritz Cocktail</h3>
    ...
    <div class="imgCont">
      <img id="drinkPicRec" src="../pics/grapefruitRec.jpg" />
      ...
      if (isset($_POST["mangojito"])) {
        ...
        <select id='drink' name='drink'>
          ...
          <option value='Grapefruit Spritz'selected>Grapefruit Spritz</option>
...
?>
    ...
    <h3 class="desOrngRec">Grapefruit Spritz Recipe - 1 Serving</h3>
    <ul class="recipe">
      <li>1.5oz Aperol</li>
      <li>1oz Grapefruit Juice</li>
      <li>1/4oz Leomon Juice</li>
      <li>1/3oz Sugar Syrup</li>
      <li>Topped with Prosecco</li>
    </ul>
    <p class="description">
      A refreshing sweet and bitter version of an aperol spritz. This low-proof
      perfectly balanced drink is always a fun option!
    </p>
  </body>
</html>
