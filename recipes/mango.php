...
<html lang="en">
  ...
  <a href="../home.html">
    ...
    <h3 id="par">Mangojito Cocktail</h3>
    ...
    <div class="imgCont">
      <img id="drinkPicRec" src="../pics/mangojitoRec.jpg" />
      ...
      if (isset($_POST["mangojito"])) {
        ...
        <select id='drink' name='drink'>
          <option name='drink' value='Mangojito' selected>Mangojito</option>
...
?>
    ...
    <h3 class="desOrngRec">Mangojito Recipe - 1 Serving</h3>
    <ul class="recipe">
      <li>1oz Mango Syrup</li>
      <li>1/2 Lime</li>
      <li>2 tsp Glolden Sugar</li>
      <li>10 Fresh Mint Leaves</li>
      <li>2oz Malibu Mango Rum</li>
      <li>Topped with lime flavoured bubbly water</li>
    </ul>
    <p class="description">
      An exceptional twist on the classic mojito, made with delicious sweet
      mango and mango rum. Refreshing, sweet and bubbly!
    </p>
  </body>
</html>
